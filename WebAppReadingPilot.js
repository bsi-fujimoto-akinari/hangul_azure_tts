  ...
  'eb2cdc555f9d70255d65cc34349fae8bec42265e69d69f636da544a83b9ab17d': {
    ...
    items: {
      'OFF-H3-P9-001': {
        ...
        explanation: {
          reason:
            '部長は字幕チームの増員について、事情をよりよく知るパク課長に一任している。④「私よりはパク課長の方が事情をよく知っているだろうから」が、その直後の「パク課長が全部担当してください」につながるため最も適切だ。',
          learning_blocks: [
            {
              form: '-(으)ㄹ 테니',
              usage:
  ...
  'c67e214de5583546d76d585dda847343bb29d03461b3b044f3d3b935a9242361': {
    ...
    items: {
      'OFF-H3-P10-001': {
        ...
        explanation: {
          reason:
            '空欄の後は「夏が来る前に急いで買った」と続くため、空欄には早めに買う理由が必要だ。①暑くなりそう、②夏になると高くなりそう、④そのまま使うと止まりそう、はいずれも理由になる。③「インターネットではいつでも安く買えそう」は急ぐ理由にならないため、適切ではない。',
          learning_blocks: [
            {
              form: '-(으)ㄹ 것 같아서',
              usage:
...
function h3ReadingP8Explanation_(
  ...
  var specs = {
    'OFF-H3-P8-001': {
      reason:
            '前文は「一日くらい休めればちょうどよい」と述べた後、実際には休みにくい状況を受けて「心に余裕を持って木曜日を耐えてみよう」と続く。①②④はいずれも休めない事情を表すが、③は「そうするのが嫌だから」という本人の意思で、文脈上の制約とは合いない。',
      learning_blocks: [
        {
          form: '-(으)니',
          usage:
        ...
        },
        {
          form: '사정',
          usage:
            '事情、都合。그럴 사정이 안 되다 は「そうできる事情・都合ではない」という意味だ。'
        },
        {
          form: '자기 마음대로',
          usage:
    ...
    'OFF-H3-P8-002': {
      reason:
            '本文の中心は、一般に月曜日がつらいと思われている一方、研究では木曜日のほうが疲労を強く感じやすいと確認された、という対比だ。したがって①が本文全体を最もよく表す。②は内容が広すぎ、③の「風邪との比較」は本文になく、④は「木曜日に休もう」という主張ではない。',
      learning_blocks: [
        {
          form: '월요병 / 목요병',
          usage:
            '本文では「月曜病」という一般的なイメージと、木曜日の疲労感を対比している。タイトル選択ではこの対比が中心情報だ。'
        },
        {
          form: '무기력에 빠지다',
          usage:
