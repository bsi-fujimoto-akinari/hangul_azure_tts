    ...
    items: {
      'OFF-H3-P11-001': {
        ...
        explanation: {
          ...
          reason:
            'ここで -기는요 は相手の評価を受けて強く打ち消す表現だ。後続の 벌써 예순인데요（もう60ですよ）が、その反駁を支えている。したがって①「若いなんてとんでもないです。」が合う。',
          learning_blocks: [
            {
              form: '-기는요',
              usage:
            '相手の発言・評価を「～だなんて、とんでもない」のように打ち消する。'
            },
            {
              form: '벌써',
              usage:
      ...
      'OFF-H3-P11-002': {
        ...
        explanation: {
          body_ja:
            '私は社長に言われたとおりにしただけです。',
          reason:
            '-는 대로 は「～する通りに」、-았/었을 뿐이다 は「～しただけだ」を表す。시키시는 대로 했을 뿐입니다 はこの二つが組み合わさり、「言われたとおりにしただけです。」となるため②が適切だ。',
          learning_blocks: [
            {
              form: '-는 대로',
              usage:
            ...
            },
            {
              form: '시키다',
              usage:
            '「させる、命じる」。文脈では 사장님께서 시키시다 が「社長が指示する」だ。'
            }
          ]
        }
      }
    ...
    items: {
      'OFF-H3-P12-001': {
        ...
        explanation: {
          ...
          reason:
            '「顔色をうかがう」は相手の反応や機嫌を気にする意味なので、慣用表現 눈치 보다 が対応する。さらに後続が「自分の意見を言ってください」なので、禁止から次の行動へつなぐ -지 말고 が自然だ。したがって② 눈치만 보지 말고 が適切だ。',
          learning_blocks: [
            {
              form: '눈치 보다',
              usage:
      ...
      'OFF-H3-P12-002': {
        ...
        explanation: {
          ...
          reason:
            '덜 は「より少なく」、아프다 は「痛い」なので 덜 아프다 は「痛みがより少ない＝痛みが和らぐ」に対応する。①と④は悪化する意味で反対、②の 낫다 は「治る」で意味が強すぎるため、③が適切だ。',
          learning_blocks: [
            {
              form: '덜 + 형용사',
              usage:
            ...
            },
            {
              form: '-(으)ㄹ 거예요',
              usage:
            '未来の見込み・予測を表す。ここでは薬を飲んだ後の状態の予測だ。'
            },
            {
              form: '낫다 ↔ 덜 아프다',
              usage:
...
var H3_TRANSLATION_V2_EXPLANATION_OVERLAY_ = {
  ...
  'AUTH-H3-P12-RT-SK017-001': {
    ...
    explanation: {
      ...
      reason:
            '눈치를 보다 は「顔色・反応をうかがう」、-느라 はある行為が原因で後続の望ましくない結果になったことを表す。したがって① 주변 사람들의 눈치를 너무 보느라 が最も自然だ。',
      learning_blocks: [
        {
          form: '눈치를 보다',
          usage:
